-- QUICK FIX for ROUND function type mismatch
...
-- Test it
SELECT COUNT(*) as cyclones_near_mumbai 
FROM find_cyclones_near_point(19.0760, 72.8777, 100000);

SELECT * FROM find_cyclones_near_point(19.0760, 72.8777, 100000) LIMIT 5;
